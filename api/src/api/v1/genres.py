...
from src.api.v1.schemas.genre import Genre
from src.models.genre import Genre as Model
...
@router.get("/", response_model=list[Genre], summary="Список жанров", description="Возвращает полный список жанров")
